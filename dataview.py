from tkinter import Tk, Frame, Button, Label, Entry, Text, INSERT
...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        self.txtX.grid(row=3,column=0, stick="W")
        self.txtY.grid(row=3,column=1, stick="W")
        ...
        self.stats=Button(self.master, text="Show Stats II",
        style="D.TButton")
